...
extern "C" {
    ...
    SWIGEXPORT jint JNICALL Java_com_theveganrobot_cvcamera_jni_cvcameraJNI_DETECT_1SQUARES_1get(JNIEnv* jenv, jclass jcls) {
        jint jresult = 0 ;
        int result;
    ...
    SWIGEXPORT void JNICALL Java_com_theveganrobot_cvcamera_jni_cvcameraJNI_Processor_1detectAndDrawContours(JNIEnv* jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jlong jarg3, jobject jarg3_) {
        Processor* arg1 = (Processor*) 0 ;
        int arg2 ;
        image_pool* arg3 = (image_pool*) 0 ;
